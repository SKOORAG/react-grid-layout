    ...
    , _ref5) {
      ...
      if (!hasCollisions) {
        if (["react-resizable-handle-sw", "react-resizable-handle-w", "react-resizable-handle-nw", "react-resizable-handle-n", "react-resizable-handle-ne"].indexOf(node.classList.item(1)) !== -1) {
          ...
          if (["react-resizable-handle-sw", "react-resizable-handle-nw", "react-resizable-handle-w"].indexOf(node.classList.item(1)) !== -1) {
            x = l.x + (l.w - w);
            x = x < 0 ? 0 : x;
          }

          if (["react-resizable-handle-ne", "react-resizable-handle-n", "react-resizable-handle-nw"].indexOf(node.classList.item(1)) !== -1) {
            y = l.y + (l.h - h);
            y = y < 0 ? 0 : y;
          }
